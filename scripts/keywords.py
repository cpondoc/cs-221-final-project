...
def main(): 
    final_data_reader = csv.DictReader(open("data/final_data.csv"))
    tagged_transcript_dictionary = {} # includes the tagged list information (nouns, adjectives, etc.) for a given TED video
